...
#                    echo "bias: $bias <br>";
    ...
    */
    ...
    {
#        echo "$delta $npoints $is_first<br>";
        $delta = (int) ($is_first ? ($delta / $this->_damp) : ($delta / 2));
        $delta += (int) ($delta / $npoints);
        for ($k = 0; $delta > (int) ((($this->_base - $this->_tmin) * $this->_tmax) / 2); $k += $this->_base) {
...
class Net_IDNA_php4 extends idna_convert
{
    ...
    {
        return $this->IC->set_parameter($option, $param);
    }
}
